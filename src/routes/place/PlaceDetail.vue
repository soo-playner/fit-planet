    ...
    <div class="detail_container main-layout">
        <div class="detail_container_inner mob-inner">
            ...
            <div class="place-convenience">
                ...
                <div class="free">
                    ...
                    <ul class="free-list">
                        ...
                        <li><div class="free-icon free-icon-4"></div><p>체형분석</p></li>
                        <li><div class="free-icon free-icon-5"></div><p>체성분검사</p></li>
                        <li><div class="free-icon free-icon-6"></div><p>주차장</p></li>
                        <li><div class="free-icon free-icon-7"></div><p>사우나</p></li>
                        <li><div class="free-icon free-icon-8"></div><p>찜질방</p></li>
                    </ul>
                </div>
                <div class="pay">
            ...
            <div class="place-machine">
                ...
                <div class="place-machine-list" v-for="machineItem in machine" :key="machineItem">
                    <span class="place-machine-tit f-14-400">{{ machineItem.title }}</span>
                    <ul>
                        <li v-for="(data,idx) in machineTag[idx]" :key="idx">{{ data }}</li>
                        <!-- <li>파워랙</li>
                        <li>스미스머신</li>
                        <li>치닝디핑</li>
                        <li>케이블 머신</li> -->
