        ...
        <div class="detail_container_inner mob-inner">
            ...
            <div class="place-map">
                <Swiper v-bind="swiperOption1">
                    <SwiperSlide>
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3165.085678942443!2d127.05573197635974!3d37.50589732760229!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x357ca414371b94b3%3A0xbfc791d5b09e4135!2z7ISc7Jq47Yq567OE7IucIOqwleuCqOq1rCDsgrzshLHroZw4Nuq4uCAxMQ!5e0!3m2!1sko!2skr!4v1690959074813!5m2!1sko!2skr" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            ...
            <Swiper class="place-ticket" v-bind="swiperOption2">
                <SwiperSlide>
                    <div class="f-14-400">1:1 PT 1회 체험권</div>
                    <div>
                        <p class="f-16-700 month">29,900원/회</p>
                        <span class="f-12-400 price">결제금액 29,900원</span>
                    </div>
                </SwiperSlide> 
                <SwiperSlide>
                    <div class="f-14-400">1:1 PT 10회</div>
                    <div>
                        <p class="f-16-700 month">49,900원/회</p>
                        <span class="f-12-400 price">결제금액 499,000원</span>
                    </div>
                </SwiperSlide> 
                <SwiperSlide>
                    <div class="f-14-400">바디 프로필 프로젝트 30회</div>
                    <div>
                        <span class="discount f-12-400">60,000원 할인</span>
                        <p class="f-16-700 month">10% 47,900원/회</p>
                        <span class="f-12-400 price">결제금액 1,437,000원</span>
                    </div> 
                </SwiperSlide>
                <SwiperSlide>
                    ...
                    <li>
                        ...
                        <div class="place-facility-list-detail">
                            ...
                            <div class="place-info">
                                ...
                                <div class="right-row"><div class="heart"><img src="@/assets/image/heart-off.png" alt="찜하기"></div></div>
                            </div>
                        </div>
                    </li>
                    <li>
            ...
            <div class="place-operate">
                ...
                <div class="place-operate-detail">
                    <div>
                        <div><span>평일</span><p>06:00 - 23:59</p></div>
                        <div><span>토요일</span><p>08:00 - 19:00</p></div>
                        <div><span>공휴일</span><p>10:00 - 18:00</p></div>
                        <div><span>일요일</span><p>10:00 - 18:00</p></div>
                    </div>
            ...
            <div class="qualify">
                ...
                <div class="qualify-content">
                    ...
                    <p class="f-12-400">스포츠영양코치 Level 2</p>
                    <p class="f-12-400">하지통합재활전문가</p>
                    <p class="f-12-400">하지기능운동재활전문가</p>
                    <div class="more f-12-400">더 보기<span></span></div>
                </div>
            </div>
            <!-- 학력 -->
