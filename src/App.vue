...
export default {
    ...
    data: () => ({
        ...
        notVisiable2: [
            /* 인트로 */ "Splash", "Intro",
            /* 로그인 */ "Login",
            /* 회원가입 */ "JoinStep1", "JoinStep2", "JoinStep3", "JoinComplete", "Authority",
            ...
            /* 플레이스 */ "PlaceTrainer", "PlaceDetail", "PlaceMachine", "PlacePay_Complete", "PlaceMachine_Choice", "PlaceTicket_Complete",
            /* 트레이너 */ "TrainerPay_Complete", "TrainerDetail", "TrainerTicket_Complete", "TrainerReview", "TrainerMachine_Choice",
